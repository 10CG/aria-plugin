...
expect_redact "SilkNode API key"     "silknode-api-key"    "API key: sk-silk-FAKEFIXTUREPLEASEDoNotDetectMeABCDEFGH01234567890123456789"
...
expect_redact "GitHub PAT"           "github-pat"          "Token: ghp_FAKEFIXTUREPLEASEDoNotDetectMeABCD00"
